...
# import policy_gradient.PolicyGradient as DiscretePolicyGradient
from PG_ac_box import PolicyGradient
...
if discrete_ac:
    policy = DiscretePolicyGradient(action_dim=A_DIM, state_dim=S_DIM, learning_rate=learning_rate, reward_decay=reward_decay)
else:
